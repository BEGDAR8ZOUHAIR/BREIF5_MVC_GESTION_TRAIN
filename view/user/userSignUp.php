  ...
  <body>
    ...
    <div class="container-xxl">
      ...
      <div class="d-flex justify-content-center" style="width:100%">
        <div class="col-md-6">
          <form class='d-flex justify-content-center flex-column mx-auto w-50 border rounded border-info shadow p-4 m-4' action="http://localhost/trains/User/userSignUp" method="POST">
            <div class="row mb-4">
           ...
           <div class='d-flex justify-content-center mb-5'>
             ...
             <a class="link-secondary text-decoration-none" href="http://localhost/trains/user/userLogin">Log in</a>
           </div>
