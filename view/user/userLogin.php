...
<html lang="en">
  ...
  <body>
    ...
    <div class="container-xxl">
      <a href="http://localhost/trains/user/index" class="navbar-brand text-white">zouhair speed</a>
      <a href="http://localhost/trains/user/index" class="nav-link link-secondary text-white">back to home</a>
      </div>
    </div>
  </nav>
      ...
      <div class="d-flex justify-content-center" style="width:100%">
        <div class="col-md-6">
          <form class='d-flex justify-content-center flex-column mx-auto w-50 border rounded border-info shadow p-4 m-4' action="http://localhost/trains/User/userLogin" method="POST">
            <div class="row mb-4">
           ...
           <div class='d-flex justify-content-center'>
             ...
             <a class="link-secondary text-decoration-none" href="http://localhost/trains/user/userSignUp">Sign Up</a>
           </div>
