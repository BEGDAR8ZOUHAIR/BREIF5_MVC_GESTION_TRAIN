...
<nav class="navbar navbar-expand-lg bg-secondary">
    <div class="container-xxl">
      ...
      <a href="http://localhost/trains/user/index" class="nav-link text-white">back to home</a>
      </div>
    </div>
  </nav>  
 ...
 <!-- ////////////////////////////// --> 
  <main style='min-height:calc(100vh - 112px);'>
    <!-- <img class='img-fluid not-found d-block mx-auto mt-5' src='https://cdn.dribbble.com/users/2698098/screenshots/5957957/media/6a4be3f4baaafe31276133fa9de7c0f0.jpg' alt=''>
  ...
  <table class='table rounded table-success mx-auto'>
    <tr class='d-flex justify-content-center' style='border:transparent;'>
      ...
      <td class='p-4'>comfort : <?php echo $ticket["myComfort"] ?></td>
            ...
            <form action="http://localhost/trains/user/myTrips" method='POST'>
