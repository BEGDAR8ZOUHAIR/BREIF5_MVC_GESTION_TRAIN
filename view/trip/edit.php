...
<section style="min-height: calc(100vh - 56px - 56px);">
    ...
    <div class="d-flex justify-content-center" style="width:100%">
      <div class="col-md-6">
        <form class='form d-flex justify-content-center flex-column border rounded border-info shadow p-4 m-4' action="http://localhost/trains/Trip/update/<?=$Trip['id']?>" method="POST">
