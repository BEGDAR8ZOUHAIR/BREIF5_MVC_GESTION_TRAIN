...
<html lang="en">
  ...
  <body>
    ...
    <div class="container-xxl">
      <a href="http://localhost/trains/user/index" class="navbar-brand">weego</a>
      <a href="http://localhost/trains/user/index" class="nav-link link-secondary">back to home</a>
      </div>
    </div>
  </nav>
      ...
      <div class="d-flex justify-content-center" style="width:100%">
        <div class="col-md-6">
          <form class='d-flex justify-content-center flex-column mx-auto w-50' action="http://localhost/trains/Admin/adminLogin" method="POST">
            <div class="row mb-4">
